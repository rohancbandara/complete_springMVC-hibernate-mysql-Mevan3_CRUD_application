...
<body>
    ...
    <label>Confirm Password</label>
    	<input name="txtConformPassword" type="password" id="txtConformPassword" /><br>

    <label for="exampleInputEmail1">Name</label><br>
    	<input name="txtFName" type="text" id="txtFName" placeholder="First Name" />
	...
	<option value="Option1">Christmas Island +61</option>
	<option value="Option2">Cocos (keeling) Islands +61</option>
	...
	<option value="Option3">Italy +39</option>
	...
	<option value="Option4">Mayotte +269</option>
	...
	<option value="Option5">Norfolk Island +672</option>
	...
	<option value="Option6">Russian Federation +7</option>
	<option value="250">Rwanda +250</option>
	<option value="1-869">Saint Kitts And Nevis +1-869</option>
	<option value="1-758">Saint Lucia +1-758</option>
	<option value="1-784">Saint Vincent And The Grenadines +1-784</option>
	<option value="Option7">Samoa +684</option>
	...
	<option value="Option8">United States +1</option>
    ...
    <input name="txtNumber" type="text" id="txtNumber" placeholder="Number" /><br>
